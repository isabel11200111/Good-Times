...
.on('exit', img => imh.classList.remove('.visible'));


// when we click register button run a function
// grab the front element and add a class of slid-up
...
/* globals Stripe */
// i need to register for own stripe account to make work
